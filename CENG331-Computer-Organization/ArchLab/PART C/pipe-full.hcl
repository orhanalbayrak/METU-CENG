...
#  In here modifications are implemented as in part b. 
# 
#
###########################################################################
...
#######################################################################
#																	  #
#I addded our instruction name IIADDQ inside of valid instruction!!!!!#
#																	  #
#######################################################################
...
##############################################################################################################
#																	  										 #
#I addded our instruction name IIADDQ inside of need_regids  since our instruction need to take registers!!!!!#
#																	  
##############################################################################################################
bool need_regids =
...
##################################################################################################################
#																	  										 
#I addded our instruction name IIADDQ inside of need_valC  since our instruction need to take constant!!!!!      #
#																	  
##################################################################################################################
bool need_valC =
...
################################################################################################################################
#																	  										 
#I addded our instruction name IIADDQ inside of d_srcB assigning rB since our instruction need to take srcB as DregisterB!!!!!#
#																	  
################################################################################################################################
word d_srcB = [
...
#########################################################################################################################################
#																	  										 
#I addded our instruction name IIADDQ inside of dstE  assigning rB since our instruction need to take d_destE as d_registerB !!!!!      #
#																	  
#########################################################################################################################################
word d_dstE = [
...
##############################################################################################################
#																	  										 #
#			IIADDQ needs to take first input A from E_valC 													 #
#																	  
##############################################################################################################
word aluA = [
...
##############################################################################################################
#																	  										 #
#			IIADDQ needs to take second input B from E_valB 											     #
#																	  		
##############################################################################################################
...
##############################################################################################################
#																	  										 #
#			IIADDQ needs to update condition code value 													 #
#																	  
##############################################################################################################
